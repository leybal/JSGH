...
var _taskModel = __webpack_require__(6);

var _taskModel2 = _interopRequireDefault(_taskModel);

var _taskArr = __webpack_require__(1);

var _taskArr2 = _interopRequireDefault(_taskArr);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var tasks = new _taskModel2.default(_taskArr2.default);
...
window.addEventListener('load', function () {
    (0, _task2.default)(document.getElementById('todo-list'));
});
...
var _taskAddForm = __webpack_require__(5);

var _taskAddForm2 = _interopRequireDefault(_taskAddForm);

var _task3 = __webpack_require__(0);
...
function taskController(rootElement) {
    ...
    (0, _task2.default)(rootElement, _task4.default, {
        onDone: onDone,
        onDelete: onDelete,
        onMove: onMove
    });

    (0, _taskAddForm2.default)(rootElement, {
        onSubmit: onSubmit
    });

    function onDone(task, status) {
        _task4.default.done(task, status);
    }

    function onDelete(task) {
        _task4.default.delete(task);
    }

    function onSubmit(text) {
        _task4.default.add(text);
    }

    function onMove(task) {
        _task4.default.move(task);
    }
}
...
function taskView(rootElement, tasks, actions) {
    ...
    function add(task) {
        ...
        var date = li.querySelector('.date');
...
exports.default = taskAddFromView;
...
TaskModel.prototype.done = function (task, status) {
    ...
    if (index >= 0) {
        _taskArr2.default.done = status;
        localStorage.setItem('tasksArr', JSON.stringify(_taskArr2.default));
    }
};
...
TaskModel.prototype.delete = function (task) {
    ...
    if (index >= 0) {
        ...
        _taskArr2.default.splice(index, 1);
        localStorage.setItem('tasksArr', JSON.stringify(_taskArr2.default));
    }
...
TaskModel.prototype.move = function (task) {
    ...
    if (event.target.className === 'move-up') {
        if (index === 0) {
            ...
            var taskAbove = this[index - 1];
            this[index - 1] = task;
            this[index] = taskAbove;

            _taskArr2.default[index - 1] = _taskArr2.default[index];
            _taskArr2.default[index] = taskAbove;
        }
    } else {
        if (index === this.length - 1) {
            return;
        } else {
            var taskBelow = this[index + 1];
            this[index + 1] = task;
            this[index] = taskBelow;

            _taskArr2.default[index + 1] = _taskArr2.default[index];
            _taskArr2.default[index] = taskBelow;
        }
    }
